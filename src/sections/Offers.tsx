      ...
      <div className="container">
        <div className="mt-20">
          <AnimatePresence mode="wait">
            ...
            {offers.map(
              (
                { title, description, image, imagePositionY, StartingPrice },
                index
              ) =>
                index === currentIndex ? (
                  <motion.div
                  ...
                  >
                    ...
                    <blockquote className="md:col-span-3">
                      <span className="text-4xl md:text-5xl mt-8">{title}</span>
                      <div className="text-3xl md:text-5xl lg:text-6xl mt-8 md:mt-0">
                        ...
                        <div className="mt-4 text-xl text-red-orange-500">
                          {StartingPrice}
                        </div>{" "}
                        {/* StartingPrice text with color */}
                        <a
                href="https://take.app/moderndigitallabs"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button variant="primary" className="hidden md:inline-flex text-lg">
